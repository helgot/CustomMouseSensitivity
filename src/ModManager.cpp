...
ModManager::ModManager()
{
    ...
    m_gameHook = std::make_unique<GameHook>(m_configManager->m_config,
                                            m_uiManager->GetDebugData());
...
void ModManager::Start()
{
    ...
    m_graphicsHookManager->SetGuiRenderCallback(
        [this]() { m_uiManager->Render(); });
    m_graphicsHookManager->SetHandleInputCallback(
