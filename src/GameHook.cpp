...
// This is necessary so our static detour functions can access the class
// members.
    ...
    : m_config(config), m_debugData(debugData)
{
    ...
    m_gamePtrs.sub_391B78 = reinterpret_cast<GamePointers::t_sub_391B78>(
        m_gamePtrs.baseAddress + 0x391B78);
    m_gamePtrs.sub_3915A8 = reinterpret_cast<GamePointers::t_sub_3915A8>(
        m_gamePtrs.baseAddress + 0x3915A8);

    m_gamePtrs.dword_39806BC =
        reinterpret_cast<float *>(m_gamePtrs.baseAddress + 0x39806BC);
    m_gamePtrs.dword_39806FC =
        reinterpret_cast<float *>(m_gamePtrs.baseAddress + 0x39806FC);
...
bool GameHook::CreateAndEnableHooks()
{
    ...
    if (MH_CreateHook((LPVOID)m_gamePtrs.thirdPersonHookAddress,
                      &ThirdPersonMouseSensitivity,
                      reinterpret_cast<LPVOID *>(
                          &m_original_ThirdPersonMouseSensitivity)) != MH_OK)
    {
    ...
    if (MH_CreateHook((LPVOID)m_gamePtrs.firstPersonHookAddress,
                      &FirstPersonMouseSensitivity, nullptr) != MH_OK)
    {
...
__int64 __fastcall GameHook::ThirdPersonMouseSensitivity(int64_t a1, int64_t a2,
                                                         float a3, float a4)
{
    ...
    if (!pThis)
    {
        // This should never happen, but as a fallback, call the original
        // function
    ...
    float v11, v12;
    v11 = (float)((float)((float)((float)(v6[12] - v6[11]) * v5) + v6[11]) *
                  0.017453292f) *
          *pThis->m_gamePtrs.dword_39806BC * scale; // x_scale
    v12 = (float)((float)((float)((float)(v6[14] - v6[13]) * v5) + v6[13]) *
                  0.017453292f) *
          *pThis->m_gamePtrs.dword_39806BC * scale; // y_scale
...
void __fastcall GameHook::FirstPersonMouseSensitivity(__int64 a1, __int64 a2,
                                                      __int64 a3, float a4,
                                                      float a5)
{
    GameHook *pThis = s_instance;
    ...
    *(float *)(a1 + 172) = a5;
    ...
    float scale = pThis->m_config.first_person_sensitivity * aiming_scale *
                  kFirstPersonQuakeScale / fov_scale;

    // Fix scaling to be consistent across non-scoped and scoped modes.
    *(float *)(a1 + 84) = 190.0f;
    *(float *)(a1 + 76) = 250.0f;

    float x_sens = (float)((float)((float)((float)(*(float *)(a1 + 80) -
                                                   *(float *)(a1 + 76)) *
                                           v9) +
                                   *(float *)(a1 + 76)) *
                           0.017453292f) *
                   *pThis->m_gamePtrs.dword_39806FC * scale;
    float y_sens = (float)((float)((float)((float)(*(float *)(a1 + 88) -
                                                   *(float *)(a1 + 84)) *
                                           v9) +
                                   *(float *)(a1 + 84)) *
                           0.017453292f) *
