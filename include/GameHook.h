...
private:
    ...
    struct GamePointers
    {
        ...
        using t_ThirdPersonMouseSensitivity = __int64(__fastcall *)(int64_t a1,
                                                                    int64_t a2,
                                                                    float a3,
                                                                    float a4);
        using t_FirstPersonMouseSensitivity = void(__fastcall *)(
    ...
    static __int64 __fastcall ThirdPersonMouseSensitivity(int64_t a1,
                                                          int64_t a2, float a3,
                                                          float a4);
    ...
    // --- Trampoline Pointers ---
    // This static variable will be set by MinHook to point to the original game
    // function.
    static inline GamePointers::t_ThirdPersonMouseSensitivity
        m_original_ThirdPersonMouseSensitivity;
    static inline GamePointers::t_FirstPersonMouseSensitivity
        m_original_FirstPersonMouseSensitivity;
};
} // namespace CustomSensitivity