...
public:
    ...
    std::string_view GetHookName() const override { return "RenderHookDX12"; }
...
private:
    ...
    using D3D12CreateDevice_t = HRESULT(WINAPI *)(IUnknown *, D3D_FEATURE_LEVEL,
                                                  REFIID, void **);
    ...
    using ResizeBuffers_t = HRESULT(WINAPI *)(IDXGISwapChain *, UINT, UINT,
                                              UINT, DXGI_FORMAT, UINT);
    ResizeBuffers_t m_original_ResizeBuffers = nullptr;

    using ExecuteCommandLists_t = void(WINAPI *)(ID3D12CommandQueue *, UINT,
